...
function printHTMLHeader()
{
  print '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"' . "\n" .
        ...
        '</head>' . "\n" .
	'<script src="https://www.google.com/jsapi?key=ABQIAAAAck7JDxhhUGt_SC_qER4DcRTJfc6b9Np6STWc9F4pWNYNKHXodxQGF641RBhzfDJ6oATIxmPTC68CEw" type="text/javascript"></script>'.
        '<body><center>' . "\n";
}
